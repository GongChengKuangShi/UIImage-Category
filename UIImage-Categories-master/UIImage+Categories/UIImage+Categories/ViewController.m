...
{
//    self.imageView.image = [self.imageView.image rotate:UIImageOrientationUpMirrored|UIImageOrientationRightMirrored|UIImageOrientationLeftMirrored];
    
//    self.imageView.image = [UIImage mergeImage:[UIImage imageNamed:@"image"] withImage:[UIImage imageNamed:@"image"]];
    
    self.imageView.image = [self.imageView.image getTiledImageWithSize:CGSizeMake([UIImage imageNamed:@"image"].size.width * 5, [UIImage imageNamed:@"image"].size.height * 5)];
    
//    self.imageView.image = [self.imageView.image imageRotatedByRadians:60];
}

- (IBAction)flipVertical:(UIButton *)sender
{
    self.imageView.image = [self.imageView.image flipVertical];
//    self.imageView.image = [self.imageView.image imageRotatedByDegrees:60];
}
